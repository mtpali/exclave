...
require github.com/exclavenetwork/libexclavecore v0.0.0-20260729073239-f50a4f5c685a
...
require (
	...
	github.com/exclavenetwork/exclave-core/v5 v5.50.1-0.20260729071746-04c035315929 // indirect
