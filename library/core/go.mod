...
require github.com/dyhkwong/libsagernetcore v0.0.0-20260322154241-d7a8b86c11c6
...
replace (
	github.com/v2fly/v2ray-core/v5 => github.com/dyhkwong/v2ray-core/v5 v5.47.1-0.20260322153423-87c10b7e3a30
