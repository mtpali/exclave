...
object Key {
    ...
    const val SERVER_WIREGUARD_ALLOWED_IPS = "serverWireGuardAllowedIPs"
    const val SERVER_WIREGUARD_AMNEZIA = "serverWireGuardAmnezia"
    const val SERVER_WIREGUARD_AWG_JC = "serverWireGuardAwgJc"
    const val SERVER_WIREGUARD_AWG_JMIN = "serverWireGuardAwgJmin"
    const val SERVER_WIREGUARD_AWG_JMAX = "serverWireGuardAwgJmax"
    const val SERVER_WIREGUARD_AWG_S1 = "serverWireGuardAwgS1"
    const val SERVER_WIREGUARD_AWG_S2 = "serverWireGuardAwgS2"
    const val SERVER_WIREGUARD_AWG_S3 = "serverWireGuardAwgS3"
    const val SERVER_WIREGUARD_AWG_S4 = "serverWireGuardAwgS4"
    const val SERVER_WIREGUARD_AWG_H1 = "serverWireGuardAwgH1"
    const val SERVER_WIREGUARD_AWG_H2 = "serverWireGuardAwgH2"
    const val SERVER_WIREGUARD_AWG_H3 = "serverWireGuardAwgH3"
    const val SERVER_WIREGUARD_AWG_H4 = "serverWireGuardAwgH4"
    const val SERVER_WIREGUARD_AWG_I1 = "serverWireGuardAwgI1"
    const val SERVER_WIREGUARD_AWG_I2 = "serverWireGuardAwgI2"
    const val SERVER_WIREGUARD_AWG_I3 = "serverWireGuardAwgI3"
    const val SERVER_WIREGUARD_AWG_I4 = "serverWireGuardAwgI4"
    const val SERVER_WIREGUARD_AWG_I5 = "serverWireGuardAwgI5"
    const val SERVER_WIREGUARD_AWG_HEADER_PROTECTION_KEY = "serverWireGuardAwgHeaderProtectionKey"
    const val SERVER_WIREGUARD_AWG_CONTENT_PADDING = "serverWireGuardAwgContentPadding"
    const val SERVER_WIREGUARD_AWG_REKEY_AFTER_TIME = "serverWireGuardAwgRekeyAfterTime"
    const val SERVER_WIREGUARD_AWG_REKEY_TIMEOUT = "serverWireGuardAwgRekeyTimeout"
    const val SERVER_WIREGUARD_AWG_REJECT_AFTER_TIME = "serverWireGuardAwgRejectAfterTime"
    const val SERVER_WIREGUARD_AWG_KEEPALIVE_TIMEOUT = "serverWireGuardAwgKeepaliveTimeout"
    const val SERVER_WIREGUARD_AWG_MAX_HANDSHAKE_ATTEMPTS = "serverWireGuardAwgMaxHandshakeAttempts"
    const val SERVER_WIREGUARD_AWG_RANDOMIZE_PACKET_TRAILERS = "serverWireGuardAwgRandomizePacketTrailers"
    const val SERVER_WIREGUARD_AWG_DISABLE_COOKIE_REPLIES = "serverWireGuardAwgDisableCookieReplies"
