...
object DataStore : OnPreferenceDataStoreChangeListener {
    ...
    var serverWireGuardAllowedIPs by profileCacheStore.string(Key.SERVER_WIREGUARD_ALLOWED_IPS)
    var serverWireGuardAmnezia by profileCacheStore.boolean(Key.SERVER_WIREGUARD_AMNEZIA)
    var serverWireGuardAwgJc by profileCacheStore.stringToInt(Key.SERVER_WIREGUARD_AWG_JC)
    var serverWireGuardAwgJmin by profileCacheStore.stringToInt(Key.SERVER_WIREGUARD_AWG_JMIN)
    var serverWireGuardAwgJmax by profileCacheStore.stringToInt(Key.SERVER_WIREGUARD_AWG_JMAX)
    var serverWireGuardAwgS1 by profileCacheStore.stringToInt(Key.SERVER_WIREGUARD_AWG_S1)
    var serverWireGuardAwgS2 by profileCacheStore.stringToInt(Key.SERVER_WIREGUARD_AWG_S2)
    var serverWireGuardAwgS3 by profileCacheStore.stringToInt(Key.SERVER_WIREGUARD_AWG_S3)
    var serverWireGuardAwgS4 by profileCacheStore.stringToInt(Key.SERVER_WIREGUARD_AWG_S4)
    var serverWireGuardAwgH1 by profileCacheStore.string(Key.SERVER_WIREGUARD_AWG_H1)
    var serverWireGuardAwgH2 by profileCacheStore.string(Key.SERVER_WIREGUARD_AWG_H2)
    var serverWireGuardAwgH3 by profileCacheStore.string(Key.SERVER_WIREGUARD_AWG_H3)
    var serverWireGuardAwgH4 by profileCacheStore.string(Key.SERVER_WIREGUARD_AWG_H4)
    var serverWireGuardAwgI1 by profileCacheStore.string(Key.SERVER_WIREGUARD_AWG_I1)
    var serverWireGuardAwgI2 by profileCacheStore.string(Key.SERVER_WIREGUARD_AWG_I2)
    var serverWireGuardAwgI3 by profileCacheStore.string(Key.SERVER_WIREGUARD_AWG_I3)
    var serverWireGuardAwgI4 by profileCacheStore.string(Key.SERVER_WIREGUARD_AWG_I4)
    var serverWireGuardAwgI5 by profileCacheStore.string(Key.SERVER_WIREGUARD_AWG_I5)
    var serverWireGuardAwgHeaderProtectionKey by profileCacheStore.string(Key.SERVER_WIREGUARD_AWG_HEADER_PROTECTION_KEY)
    var serverWireGuardAwgContentPadding by profileCacheStore.string(Key.SERVER_WIREGUARD_AWG_CONTENT_PADDING)
    var serverWireGuardAwgRekeyAfterTime by profileCacheStore.string(Key.SERVER_WIREGUARD_AWG_REKEY_AFTER_TIME)
    var serverWireGuardAwgRekeyTimeout by profileCacheStore.string(Key.SERVER_WIREGUARD_AWG_REKEY_TIMEOUT)
    var serverWireGuardAwgRejectAfterTime by profileCacheStore.string(Key.SERVER_WIREGUARD_AWG_REJECT_AFTER_TIME)
    var serverWireGuardAwgKeepaliveTimeout by profileCacheStore.string(Key.SERVER_WIREGUARD_AWG_KEEPALIVE_TIMEOUT)
    var serverWireGuardAwgMaxHandshakeAttempts by profileCacheStore.string(Key.SERVER_WIREGUARD_AWG_MAX_HANDSHAKE_ATTEMPTS)
    var serverWireGuardAwgRandomizePacketTrailers by profileCacheStore.boolean(Key.SERVER_WIREGUARD_AWG_RANDOMIZE_PACKET_TRAILERS)
    var serverWireGuardAwgDisableCookieReplies by profileCacheStore.boolean(Key.SERVER_WIREGUARD_AWG_DISABLE_COOKIE_REPLIES)
